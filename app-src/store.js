...
(function () {
  ...
  const CATEGORIES = [
    ...
    { key: "transport",     label: "Транспорт",           color: "var(--c3)", kind: "expense", essential: true,  impulse: false },
    ...
    { key: "sport",         label: "Спорт",               color: "var(--c1)", kind: "expense", essential: false, impulse: false },
