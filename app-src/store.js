...
(function () {
  ...
  const CATEGORIES = [
    ...
    { key: "gym",           label: "Спортзал и трениров.",color: "var(--c1)", kind: "expense", essential: false, impulse: false },
    { key: "sport",         label: "Спорт (прочее)",      color: "var(--c1)", kind: "expense", essential: false, impulse: false },
